...
class SwiftPerformanceTests: TestCase {
    ...
    func createIntObjects() -> Realm {
        return createObjects(SwiftObject.self) { (object, value) in
            object.intCol = value
        }
    }

    func createStringObjects() -> Realm {
        return createObjects(SwiftObject.self) { (object, value) in
            object.stringCol = String(value)
        }
    }
    ...
    func testLegacyIntObjectsMap() {
        let objects = createIntObjects().objects(SwiftObject.self)
        measure {
    ...
    func testLegacyStringObjectsMap() {
        let objects = createStringObjects().objects(SwiftObject.self)
        measure {
