...
class ObjectSchemaInitializationTests: TestCase {
    ...
    func testModernPropertyPopulation() {
        ...
        assertType(Map<String, Object>.self, .object, map: true, objectType: "RealmSwiftObject")
        assertType(Map<String, EmbeddedObject>.self, .object, map: true, objectType: "RealmSwiftEmbeddedObject")
        ...
        assertThrows(RLMProperty(name: "_name", value: Managed<LinkingObjects<EmbeddedObject>>()),
                     reason: "LinkingObjects<RealmSwiftEmbeddedObject> property 'name' must set the origin property name with @Managed(originProperty: \"name\").")
    }
