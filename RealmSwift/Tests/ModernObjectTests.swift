    ...
    func testObjectSchema() {
        ...
        XCTAssertEqual(schema.properties.map { $0.name },
                       ["pk", "boolCol", "intCol", "int8Col", "int16Col", "int32Col", "int64Col",
                        "floatCol", "doubleCol", "stringCol", "binaryCol", "dateCol",
                        "decimalCol", "objectIdCol", "objectCol", "arrayCol", "setCol", "anyCol",
                        "uuidCol", "intEnumCol", "stringEnumCol", "optIntCol", "optInt8Col",
                        "optInt16Col", "optInt32Col", "optInt64Col", "optFloatCol",
                        "optDoubleCol", "optBoolCol", "optStringCol", "optBinaryCol",
                        "optDateCol", "optDecimalCol", "optObjectIdCol", "optUuidCol",
                        "optObjectCol", "optIntEnumCol", "optStringEnumCol", "arrayBool",
                        "arrayInt", "arrayInt8", "arrayInt16", "arrayInt32", "arrayInt64",
                        "arrayFloat", "arrayDouble", "arrayString", "arrayBinary", "arrayDate",
                        "arrayDecimal", "arrayObjectId", "arrayAny", "arrayUuid", "arrayObject",
                        "arrayOptBool", "arrayOptInt", "arrayOptInt8", "arrayOptInt16",
                        "arrayOptInt32", "arrayOptInt64", "arrayOptFloat", "arrayOptDouble",
                        "arrayOptString", "arrayOptBinary", "arrayOptDate", "arrayOptDecimal",
                        "arrayOptObjectId", "arrayOptUuid", "setBool", "setInt", "setInt8",
                        "setInt16", "setInt32", "setInt64", "setFloat", "setDouble", "setString",
                        "setBinary", "setDate", "setDecimal", "setObjectId", "setAny", "setUuid",
                        "setObject", "setOptBool", "setOptInt", "setOptInt8", "setOptInt16",
                        "setOptInt32", "setOptInt64", "setOptFloat", "setOptDouble",
                        "setOptString", "setOptBinary", "setOptDate", "setOptDecimal",
                        "setOptObjectId", "setOptUuid"])
    }
